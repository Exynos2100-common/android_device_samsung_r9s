...
DEVICE_RECOVERY_KERNEL_MODULES := $(addprefix $(TARGET_RECOVERY_ROOT_OUT)/lib/modules/,$(shell cat device/samsung/r9s/modules.load))

INSTALLED_KERNEL_TARGET := $(PRODUCT_OUT)/kernel
INTERNAL_RECOVERY_RAMDISK_FILES_TIMESTAMP := $(call intermediates-dir-for,PACKAGING,recovery)/ramdisk_files-timestamp

$(DEVICE_RECOVERY_KERNEL_MODULES): $(INSTALLED_KERNEL_TARGET)
...
$(INTERNAL_RECOVERY_RAMDISK_FILES_TIMESTAMP): $(DEVICE_RECOVERY_KERNEL_MODULES)
endif
